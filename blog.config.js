...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Kingwempity', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '敬请T期待', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion.kingwempity.top', // 网站地址
  ...
  GREETING_WORDS:
    ...
    'Hi,welcom to my Blog!,路漫漫其修远兮，吾将上下而求索。',
